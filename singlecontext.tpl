...
<h2>
<a href="javascript:toggle('c<?=$contextID;?>');javascript:toggleImage('toggle_context_<?=$contextID;?>')" 
	title="Show/hide context">
<img src="<?=$c->BASE_URL?>/img/collapse.png" name="toggle_context_<?=$contextID;?>" alt="expand/collapse context" /></a>
<a href="<?=$c->BASE_URL?>/context/display/<?=$contextID;?>"><?=$contextName;?></a></h2>
<div id="c<?=$contextID;?>">
